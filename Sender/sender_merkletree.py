...
class MerkleTools(object):
    def __init__(self, hash_type="sha256"):
        ...
        if hash_type in ['sha256', 'md5', 'sha224', 'sha384', 'sha512',
            ...
            try:
                ...
                self.hash_function = self.hash160
        else:
    ...
    def hash160(self,x):
        sha_256_value = hashlib.sha256(x).digest()
        hash_160_value = hashlib.new('ripemd160', sha_256_value)
        return hash_160_value
    ...
    def get_proof(self, index):
        if self.levels is None:
            ...
            for x in range(len(self.levels) - 1, 0, -1):
                ...
                sibling_pos = 0 if is_right_node else 1
